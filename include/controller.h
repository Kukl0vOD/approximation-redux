...
//беяэ йнмрпнккеп днкфем ашрэ смхврнфем х оепеохяюм гюмнбн
//окнрреп рнфе
//юоопнйяхлюрнп хлеер опнакелш я пюглепмнярълх
...
public:
    ...
    void                            compareVolumeAndSpecificApprox(const std::string& json_output_filename, double pressure_start, double pressure_end, double pressure_inc, std::array<double, 3> fixed_pressures, std::pair<size_t, size_t> indecies);
