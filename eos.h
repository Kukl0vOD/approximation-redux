...
namespace eos
{
	...
	public:
		...
		virtual double				calculateSolutionA(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>&, Matrix<double> bip, double temperature) const = 0;
		virtual double				calculateSolutionB(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>&) const = 0;
		...
		virtual std::vector<double> calculateZFactor(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>& concentration, Matrix<double> bip, sol::State current_state) const = 0;
	};
	...
	public:
		...
		double						calculateSolutionA(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>&, Matrix<double> bip, double temperature) const override;
		double						calculateSolutionB(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>&) const override;
		...
		std::vector<double>			calculateZFactor(const std::vector<sol::Component>& components, const std::unordered_map<std::string_view, double>& concentration, Matrix<double> bip, sol::State current_state) const override;
	};
